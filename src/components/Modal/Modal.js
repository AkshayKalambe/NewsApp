  ...
  if (isOpen && showFeedback) {
    ...
    body = (
      ...
      <div className={classes.paper}>
        ...
        <Typography variant="body1" className={classes.trySaying}>Try saying: &quot;Give me the latest <strong><em>Business</em></strong> news&quot;
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>{['Donald Trump', 'PlayStation 5', 'Smartphones'].map((term) => <Chip label={term} color="primary" className={classes.chip} />)}<Chip label="...and more" className={classes.chip} /></div>
        </div>
